...
class TestFilterVacancies(unittest.TestCase):
    def setUp(self):
        self.vacancies_list = [
            {"title": "Разработчик Python", "description": "Опыт разработки на Python от 3 лет."},
            {"title": "Frontend разработчик", "description": "Знание HTML, CSS, JavaScript"},
            {"title": "QA Engineer", "description": "Тестирование программного обеспечения"}
        ]

    def test_filter_vacancies_with_single_word(self):
        filter_words = ["Python"]
        expected_result = [{'description': 'Опыт разработки на Python от 3 лет.',
...
class TestGetVacanciesBySalary(unittest.TestCase):
    ...
    def test_get_vacancies_above_threshold(self):
        salary = 90000
        expected_result = [{'salary': {'from': 80000}, 'title': 'Frontend разработчик'},
...
class TestSortVacancies(unittest.TestCase):
    ...
    def test_sort_vacancies_descending(self):
        expected_result = [{'salary': {'from': 120000}, 'title': 'Разработчик Python'},
...
class TestPrintVacancies(unittest.TestCase):
    ...
    def test_print_vacancies_with_data(self, mock_print):
        # Тестовые данные
        vacancies = [
            {"ID": 1, "name": "Engineer", "salary": {"from": 50000}, "url": "http://example.com", "snippet": {"responsibility": "Engineering stuff"}},
            {"ID": 2, "name": "Developer", "salary": {"from": 60000}, "url": "http://example.com/dev", "snippet": {"responsibility": "Developing stuff"}}
        ]
